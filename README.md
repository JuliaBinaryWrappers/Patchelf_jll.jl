# `Patchelf_jll.jl` (v0.18.1+0)

[![deps](https://juliahub.com/docs/Patchelf_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Patchelf_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/219da06baf75a4d5d40565b073d5c0c17c36d16d/P/Patchelf/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
